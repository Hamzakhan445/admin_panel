...
<!--         -----------------------------------------------------------------------
 ...
 $mselect = "select * from driver_table";
    if ($driver != "" && $driver != " " ) {
        // code......
        $mselect = "select * from driver_table where operator_id LIKE '%$driver%' OR car_number LIKE '%$driver%' OR vehicle_type LIKE '%$driver%' OR id = '$driver' ";
    }
    ...
    <tr>
      ...
      <td> <?php echo $show['operator_id'] ?></td>
