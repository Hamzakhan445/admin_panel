...
<!--         -----------------------------------------------------------------------
        ...
        ----------------------------------------------------------------------- -->
         ...
         <div class="form-merchant bg-white  p-5 shadow  w-75 mx-auto mt-3 ">
             ...
             <form action="merchant_query.php" method="post" enctype="multipart/form-data" >
                 
                 <div class="row">

            <div class="col-lg-5">
            <label for="input"> Merchant Name </label>
            <input type="text" required class="form-control " name="merchant_name" >
             </div>

                <div class="col-lg-5">
            <label for="input"> Merchant Email </label>
            <input type="text" required class="form-control " name="merchant_email" >
             </div>
     
                <div class="col-lg-5">
            <label for="input"> Merchant Password </label>
            <input type="password" required class="form-control " name="merchant_password" >
             </div>

                <div class="col-lg-5">
            <label for="input"> Merchant Address </label>
            <input type="text" required class="form-control " name="merchant_address">
             </div>

                <div class="col-lg-5">
            <label for="input"> Merchant City </label>
            <input type="text" required class="form-control " name="merchant_city">
             </div>
            ...
            <input type="file" required class="form-control " name="merchant_logo" >
             </div>

                <div class="col-lg-5">
            <label for="input">  Profile Img   </label>
            <input type="file" required class="form-control " name="merchant_img" >
             </div>
             ...
             <input type="submit" class="btn btn-outline-dark mt-3" value="Add Merchant" name="add_merchant" >
