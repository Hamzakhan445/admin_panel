...
<!--         -----------------------------------------------------------------------
        ...
        ----------------------------------------------------------------------- -->
         ...
         <div class="form-merchant bg-white  p-5 shadow  w-75 mx-auto mt-3 ">
             ...
             <form action="operator_query.php" method="post" enctype="multipart/form-data" >
                 
                 <div class="row">

            <div class="col-lg-5">
            <label for="input"> Operator Name </label>
            <input type="text" required class="form-control " name="operator_name" >
             </div>

                <div class="col-lg-5">
            <label for="input">Operator Email </label>
            <input type="text" required class="form-control " name="operator_email" >
             </div>
     
                <div class="col-lg-5">
            <label for="input">Operator Password </label>
            <input type="password" required class="form-control " name="operator_password" >
             </div>
            ...
            <input type="text" required class="form-control " name="operator_address">
             </div>

                <div class="col-lg-5">
            <label for="input">Operator City </label>
            <input type="text" required class="form-control " name="operator_city">
             </div>

                <div class="col-lg-5">
            <label for="input">   Company </label>
            <input type="text" required class="form-control " name="operator_company" >
             </div>
 
                <div class="col-lg-5">
            <label for="input">  Profile Img   </label>
            <input type="file" required class="form-control " name="operator_img" >
             </div>
             ...
             <input type="submit" class="btn btn-outline-dark mt-3" value="Add Operator" name="add_operator" >

             </form>

         </div>
 <!--   $insert = "insert into table_merchant(name,email,password,profile_picture,address,company,parking_logo,city,role_id)values('$merchant_name', '$merchant_email', '$merchant_password', '$locat', '$merchant_address','$company', '$parking_logo', 2)"; -->
