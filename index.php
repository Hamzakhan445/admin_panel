                ...
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            ...
                            $select_operat = "select * from operator_table";
                            $run_select = mysqli_query($con, $select_operat);

                            $operat = mysqli_fetch_array($run_select);

                            ?>
                            <span class="count"><?php echo $operat['id']; ?></span>
                        </h4>
                        <p class="text-light">Total Operators</p>
                    ...
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                         ...
                         <?php 
                            ...
                            $select_merch = "select * from merchant_table";
                            $run_merch = mysqli_query($con, $select_merch);

                            $merch = mysqli_fetch_array($run_merch);

                            ?>
                        <h4 class="mb-0">
                            <span class="count"><?php echo $merch['id']; ?></span>
                        </h4>
                        <p class="text-light"> Total Merchants </p>
