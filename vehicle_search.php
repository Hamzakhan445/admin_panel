...
<!--         -----------------------------------------------------------------------
 ...
 $mselect = "select * from vehicle_pricing";
    if ($vehicle != "" && $vehicle != " " ) {
        // code......
        $mselect = "select * from vehicle_pricing where merchant_id LIKE '%$vehicle%' OR vehicle_type LIKE '%$vehicle%' OR price_perhour LIKE '%$vehicle%'  ";
    }
