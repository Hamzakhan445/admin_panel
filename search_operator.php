                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="add_operator.php"> Add Merchant  </a></li>
                            <li><i class="fa fa-table"></i><a href="show_operator.php"> Show Merchant  </a></li>
                        </ul>
                    </li>
...
<!--         -----------------------------------------------------------------------
   ...
   <div class="table bg-white mx-auto " style="width:98%;">
    ...
    <form method="post" action="search_operator.php">

        <div class="d-flex   align-items-center w-75 ">
    <input type="search" class="form-control w-75 mt-3" required name="text" placeholder="Search here ..." >
    <input type="submit" value="Search" name="search" class="btn btn-outline-dark mx-3 mt-3">
    </div>
    </form>
 ...
 $mselect = "select * from operator_table";
    if ($keyword != "" && $keyword != " " ) {
        // code......
        $mselect = "select * from operator_table where operator_name LIKE '%$keyword%' OR email LIKE '%$keyword%' OR username LIKE '%$keyword%' OR address LIKE '%$keyword%' OR city LIKE '%$keyword%' OR id = '$keyword' ";
    }
...
*/
    ...
    <tr>
      ...
      <td> <?php echo $show['operator_name'] ?></td>
      <td><?php echo $show['username'] ?></td>
       <td><?php echo $show['address'] ?></td>
      <td><?php echo $show['city'] ?></td>
<td> <img src="<?php echo $show['operator_profile']; ?>" style="width: 50px;height: 50px; object-fit: contain;"  alt=""> </td>
      <td><?php echo $show['role_id'] ?></td>

      <td> 

            <a href="operator_update.php?idd=<?php echo $show['id']; ?>" class="badge-success p-1" data-toggle="tooltip" title="Hooray!"> Edit    </a>
