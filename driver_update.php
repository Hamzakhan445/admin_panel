...
<!--         -----------------------------------------------------------------------
        ...
        ----------------------------------------------------------------------- -->
       	...
       	<?php 
       		...
       		$selectdata = "select * from driver_table where id = $id ";
     ...
     $operator_id = $_POST['operator_id'];
      ...
      $vehicle_type = $_POST['vehicle_type'];
     	...
     	$updatequery = "update driver_table set id = $idd, operator_id = '$operator_id', car_number = '$car_number', vehicle_type = '$vehicle_type' where id= $idd ";
      ...
      if ($rquery) {
      	...
      	echo "<script> alert('Data Updated'); window.location.href = 'show_driver.php';  </script> ";
      }
      ...
      else
      {
         ...
         <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="col-lg-5">
            <label for="input"> Operator Id   </label>
            <input type="text" value="<?php  echo $showdata['operator_id'] ?>" required class="form-control " name="operator_id" >
             </div>

                <div class="col-lg-5">
            <label for="input"> car_number </label>
            <input type="text" value="<?php  echo $showdata['car_number'] ?>" required class="form-control " name="car_number" >
             </div>
     
                <div class="col-lg-10">
            <label for="input">vehical Type  </label>
            <input type="text" value="<?php  echo $showdata['vehicle_type'] ?>" required class="form-control " name="vehicle_type" >
             ...
             <input type="submit" class="btn btn-outline-dark mt-3" value="update Driver" name="update_driver" >
