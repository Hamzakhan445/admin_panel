...
<!--         -----------------------------------------------------------------------
        ...
        ----------------------------------------------------------------------- -->
         ...
         <div class="form-merchant bg-white  p-5 shadow  w-75 mx-auto mt-3 ">
             ...
             <form action="driver_query.php" method="post" enctype="multipart/form-data" >
                 
                 <div class="row">

            <div class="col-lg-5">
            <label for="input"> Operator Id   </label>
            <input type="text" required class="form-control " name="operator_id" >
             </div>

                <div class="col-lg-5">
            <label for="input"> car_number </label>
            <input type="text" required class="form-control " name="car_number" >
             </div>
            ...
            <input type="text" required class="form-control " name="vehicle_type" >
             ...
             <input type="submit" class="btn btn-outline-dark mt-3" value="Add Driver" name="add_driver" >
