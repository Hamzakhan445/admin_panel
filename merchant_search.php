...
<!--         -----------------------------------------------------------------------
 ...
 $mselect = "select * from merchant_table";
    if ($text != "" && $text != " " ) {
        // code......
        $mselect = "select * from merchant_table where merchant_name LIKE '%$text%' OR merchant_email LIKE '%$text%' OR merchant_address LIKE '%$text%' OR merchant_city LIKE '%$text%' OR id = '$text' ";
    }
